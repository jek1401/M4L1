...
def callback_query(call):
    ...
    if manager.get_winners_count(prize_id) < 3:
        ...
        if res:
            ...
            with open(f'C:\\Users\\user\\Documents\\IT 3 python\\M4L11\\M4L1\\img\\{img}', 'rb') as photo:
...
def send_message():
    ...
    for user in manager.get_users():
        with open(f'C:\\Users\\user\\Documents\\IT 3 python\\M4L11\\M4L1\\hidden_img\\{img}', 'rb') as photo:
